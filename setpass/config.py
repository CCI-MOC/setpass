...
default_opts = [
    ...
    cfg.StrOpt('internal_queue',
               default='Monitoring',
               help='Queue for routing tickets directly to MOC'),

    cfg.StrOpt('helpdesk_queue',
               default='Monitoring',
               help='Queue for routing tickets to Helpdesk.'),

    cfg.StrOpt('cluster',
               default='Cluster Not Specified',
               help='Name of the cluster the ticket is generated by')
]
